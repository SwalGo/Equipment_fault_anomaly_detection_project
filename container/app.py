...
def define_model():
    global model
    model = load_model(
        "/home/swalgo/project_I/Containerized-AI-for-Anomaly-Detection/container/Cloud_model.h5")
...
def submit():
    ...
    if flask.request.method == "POST":
        ...
        # normalize the data
        scaler = joblib.load(
            "/home/swalgo/project_I/Containerized-AI-for-Anomaly-Detection/container/scaler_data")
